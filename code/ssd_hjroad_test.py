...
model_def = '/home/hjin/roadtest/deploy.prototxt'
model_weights = '/home/hjin/roadtest/VGG_hjroad_SSD_512x512_iter_120000.caffemodel'
labelmap_file = '/home/hjin/roadtest/labelmap_voc.prototxt'
...
def RunDetection(InputImagePath, OutputImagePath, jpg_names, score_threshold):
    ...
    for one_jpg in jpg_names:
        ...
        for i in range(top_conf.shape[0]):
            ...
            #write in CSV
            WriteinCSV("/home/hjin/roadtest/result1_15/result1_15.csv", "origin/"+one_jpg, str(xmin), str(ymin), str(xmax), str(ymax) ,label_name, str(score) )
